			...
			<view style="display: flex;align-items: center;">
				<view style="display: flex;flex-direction: column;">
					<view style="display: flex;">
						...
						<view style="font-size: 34upx;color:#D20D04 ;font-weight: bold;">￥{{totalprice/100}}</view>
					</view>
	...
	export default {
		...
		methods: {
			...
			getchangeback() {
				...
				if (currPage.data.vid == undefined) {
					if (this.dafaultId != 0) {
						this.getalldata(this.dafaultId,replaceId)
					}
				} else {
					var ids = currPage.data.vid
					this.getalldata(ids,replaceId)
				}
				...
				if (this.calcId != null) {
					if (this.vehicleNum == null) {
						...
						let Totalgoods = this.shopsitem.filter((r) =>{
							...
							uni.setStorageSync('Totalgoods', Totalgoods)
						uni.navigateTo({
							url: `../confirmation/confirmation?index=${this.totalprice}&id=0`
						})
					}
